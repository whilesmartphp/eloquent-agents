 ...
 * @method static \Whilesmart\Agents\ValueObjects\AgentResult run(string $harness, string $input, \Whilesmart\Agents\ValueObjects\ToolContext $context, array $images = [], array $overrides = [])
